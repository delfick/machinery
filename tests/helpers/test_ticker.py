...
class TestTick:
    ...
    async def test_works_with_0_every(self, FakeTime, MockedCallLater):
        called = []
    ...
    async def test_works_with_0_every_and_nonzero_min_wait(self, FakeTime, MockedCallLater):
        called = []
    ...
    async def test_keeps_yielding_until_max_iterations(self, FakeTime, MockedCallLater):
        called = []
    ...
    async def test_keeps_yielding_until_max_time(self, FakeTime, MockedCallLater):
        called = []
    ...
    async def test_stops_if_final_future_stops(self, FakeTime, MockedCallLater):
        called = []
...
class TestATicker:
    ...
    async def test_can_change_the_after_once(self, FakeTime, MockedCallLater):
        called = []
    ...
    async def test_can_have_a_minimum_wait(self, FakeTime, MockedCallLater):
        called = []
    ...
    async def test_can_be_told_to_follow_the_schedule(self, FakeTime, MockedCallLater):
        called = []
    ...
    class TestWithAPauser:
        async def test_can_be_paused(self, FakeTime, MockedCallLater):
            called = []
        ...
        async def test_cancelled_final_future_not_stopped_by_pauser(
            self, FakeTime, MockedCallLater
        ):
            called = []
