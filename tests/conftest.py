...
class FutureDominoesImpl(AsyncCMMixin):
    """
    ...
    .. code-block:: python
        ...
        async def run():
            async with FutureDominoesImpl(expected=8) as futs:
                called = []
